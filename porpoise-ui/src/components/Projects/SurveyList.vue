<template>
  <div v-if="surveys && surveys.length > 0" class="space-y-2">
    ...
    >
      <div class="flex items-center space-x-2.5 flex-1 min-w-0" @click="navigateToSurvey(survey.id)">
        <!-- Survey Icon (same as recent surveys) -->
        ...
        <!-- Stats -->
        <div class="flex items-center space-x-2.5 text-[10px] text-gray-500 dark:text-gray-400 flex-shrink-0">
      ...
      <div class="flex items-center space-x-1.5 flex-shrink-0">
        ...
        <svg
          ...
          class="w-3.5 h-3.5 text-gray-400 cursor-pointer"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
